...
/*   Updated: 2025/02/22 20:18:09 by mteichma         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	load_images_part1(t_game *game)
{
	...
	game->item_img_1 = mlx_xpm_file_to_image(game->mlx,
		"assets/item_1.xpm", &w, &h);
}
...
static void	load_images_part2(t_game *game)
{
	...
	game->item_img_2 = mlx_xpm_file_to_image(game->mlx,
		"assets/item_2.xpm", &w, &h);
...
void	load_images(t_game *game)
{
	...
	game->player_win = mlx_xpm_file_to_image(game->mlx,
		"assets/player_win.xpm", &w, &h);
	if (!game->wall_img || !game->floor_img || !game->item_img_1
		|| !game->item_img_2 || !game->player_idle_1
		|| !game->player_idle_2 || !game->player_move_1
		|| !game->player_move_2 || !game->player_win
